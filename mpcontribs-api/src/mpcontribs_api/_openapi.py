openapi_tags = [
    ...
    {
        "name": "structures",
        "description": "are [pymatgen structures](https://pymatgen.org/pymatgen.electronic_structure.html) which can be"
        "added to a contribution.",
    },
    {
        "name": "tables",
    ...
    {
        "name": "attachments",
        "description": "are files saved as objects in AWS S3 and not accessible for querying (only retrieval) which can"
    ...
    },
    {
        ...
        "documents generated and saved when a contribution is saved. They form the basis for Contribution Details Pages"
        "on the Portal.",
    },
]
