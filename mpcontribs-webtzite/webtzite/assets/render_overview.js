...
window.render_overview = function(project, grid) {
    ...
    $.get({
        ...
        var layout = {
            ...
            height: 450 + columns.length * 100, // TODO fix for grid
        ...
        // TODO determine min/max slider ranges through API
        var columns_ranges = {
            'C [eV]': [0, 4.2],
            'ΔE-QP.indirect [eV]': [0.1, 16], 'ΔE-QP.direct [eV]': [0.1, 16.1],
            'ΔE-KS.indirect [eV]': [0.1, 16], 'ΔE-KS.direct [eV]': [0.1, 16.1]
        };
        var nsteps = 10;
        var ops = [' ≥ ', ' ≤ '];
        layout['sliders'] = [];
